...
class UsersAdminController extends AbstractActionController
{
    /**
     * @var StaffRepository
     */
     ...
     */
    public function viewUsersForAdminAction()
    {
        /** This is form view*/
        $form    = new UsersForm();
        ...
        if (!$data['id']) {
            ...
            $jsonData[$idx++] = iterator_to_array($this->staffTable->getUsersAdminByFilters(
                $searchLine,
                $data['post'],
                $data['gender'] - 1,
                $data['dobBefore'],
